...
public class Suppliers extends JPanel implements ListSelectionListener{
	...
	public Suppliers(ArrayList<Supplier> supplierList) {
		
		super(new BorderLayout());
		
		// create list of suppliers and postcodes
		this.supplierList = supplierList;
		this.postcodeList = new ArrayList<Postcode>();
		...
		for (Supplier s : supplierList) {
			nameListModel.addElement(s.getName());
			statusListModel.addElement(s.getPostcode().getName());
			postcodeList.add(s.getPostcode());
		}
